  ...
  definition: {
    ...
    components: {
      ...
      schemas: {
        ...
        DepositRequest: {
          type: 'object',
          required: ['phoneNumber', 'amount', 'currency'],
          properties: {
            phoneNumber: { type: 'string', example: '+22990123456', minLength: 8, maxLength: 15 },
            amount: { type: 'number', example: 10000, minimum: 0 },
        ...
        DepositResponse: {
          ...
          properties: {
            ...
            fiatCurrency: { $ref: '#/components/schemas/Currency' },
        ...
        WithdrawRequest: {
          type: 'object',
          required: ['phoneNumber', 'amountUsdc', 'targetCurrency'],
          properties: {
            phoneNumber: { type: 'string', example: '+22990123456' },
            amountUsdc: { type: 'number', example: 50.5, minimum: 0 },
